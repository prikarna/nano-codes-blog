...
#define USB_EP_CTL_CTRL_TRANS_IN_IN					((USB_EP_TYPE_CONTROL << 9) | BIT_HEX_7 | BIT_HEX_6 | BIT_HEX_4)
...
*/
#define USB_EP_CTL_EX_INT_TRANS_TX_INIT			(BIT_HEX_15 | (USB_EP_TYPE_INTERRUPT << 9) | BIT_HEX_7 | BIT_HEX_6 | (0x3 << 4))
...
/*
	USB_EP_CTL_EX_INT_TRANS_IN
		...
		- Toggle STAT_TX, NACK -> VALID
*/
#define USB_EP_CTL_EX_INT_TRANS_IN				(BIT_HEX_15 | (USB_EP_TYPE_INTERRUPT << 9) | BIT_HEX_4)
