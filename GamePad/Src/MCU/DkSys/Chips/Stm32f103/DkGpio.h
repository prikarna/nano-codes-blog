...
#define GPIO_SET_MODE_INPUT4(Port, Pin, CnfInp)				\
	SET_BITS(GPIO_MODE_REG(Port, Pin), GPIO_MODE_NTH_PIN(Pin), BIT_MASK_16_BITS, ((GPIO_MOD_INP | CnfInp) * 0x1111))
...
#define GPIO_SET_MODE_OUTPUT4(Port, Pin, CnfOut, ModeOut)					\
	SET_BITS(GPIO_MODE_REG(Port, Pin), GPIO_MODE_NTH_PIN(Pin), BIT_MASK_16_BITS, ((CnfOut | ModeOut) * 0x1111))
