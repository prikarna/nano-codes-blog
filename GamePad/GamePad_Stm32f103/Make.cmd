@rem +---------------------------------------------------------+
@rem   Batch file to build GamePad_Stm32f103 project
...
@set PROJ_NAME=GamePad_Stm32f103

@echo.
@echo *** Building %PROJ_NAME% project for STM32F103XXXXX microcontroller
@echo.

@set SOLUTION_DIR=D:\Microcontroller\GamePad
...
@set SRCS=%SRC_DIR%\GamePad\Init.c
@set SRCS=%SRCS% %SRC_DIR%\DkSys\DkHalUart.c
@set SRCS=%SRCS% %SRC_DIR%\DkSys\DkHalMem.c
@set SRCS=%SRCS% %SRC_DIR%\DkSys\DkHalClk.c
@set SRCS=%SRCS% %SRC_DIR%\GamePad\IntHandlers.c
@set SRCS=%SRCS% %SRC_DIR%\GamePad\UsbSetup.c
@set SRCS=%SRCS% %SRC_DIR%\GamePad\UsbEpReg0.c
@set SRCS=%SRCS% %SRC_DIR%\GamePad\UsbEpReg1.c
@set SRCS=%SRCS% %SRC_DIR%\GamePad\UsbEpReg2.c
@set SRCS=%SRCS% %SRC_DIR%\GamePad\UsbDescs.c
