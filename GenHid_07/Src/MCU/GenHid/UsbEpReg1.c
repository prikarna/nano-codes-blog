...
uint8_ptr_t				gpEp1Buf = (uint8_ptr_t) (USB_SRAM + EP1_BUF_SEG);
...
void On_EpReg1_Std_GetDesc_Hid_Phys()
{
	DBG_PRINTF("%s()\r\n", __FUNCTION__);
	DBG_BREAK();
}

void On_EpReg1_Std_GetDesc_Hid_Report()
{
	DBG_PRINTF("%s()\r\n", __FUNCTION__);
	//DBG_BREAK();
}
...
void On_EpReg1_Std_GetDesc()
{
	...
	case DESCTYPE_HID_PHYSICAL:
		On_EpReg1_Std_GetDesc_Hid_Phys();
		break;

	case DESCTYPE_HID_REPORT:
		On_EpReg1_Std_GetDesc_Hid_Report();
		break;
...
void On_EpReg1_Cls_Hid_GetReport()
{
	DBG_PRINTF("%s()\r\n", __FUNCTION__);
	//DBG_BREAK();
...
void On_EpReg1_Cls_Hid_GetIdle()
{
	DBG_PRINTF("%s()\r\n", __FUNCTION__);
	DBG_BREAK();
}

void On_EpReg1_Cls_Hid_GetProt()
{
	DBG_PRINTF("%s()\r\n", __FUNCTION__);
	DBG_BREAK();
}
...
void On_EpReg1_Cls_Hid_SetReport()
{
	...
	DBG_PRINTF("%s(): Host sent: %s\r\n", __FUNCTION__, gpEp1Buf);
...
void On_EpReg1_Cls_Hid_SetIdle()
{
	DBG_PRINTF("%s()\r\n", __FUNCTION__);
	DBG_BREAK();
}

void On_EpReg1_Cls_Hid_SetProt()
{
	DBG_PRINTF("%s()\r\n", __FUNCTION__);
	DBG_BREAK();
}
...
void On_EpReg1_ClsReq()
{
	...
	case REQTYPE_HID_GET_REPORT:
		On_EpReg1_Cls_Hid_GetReport();
		break;

	case REQTYPE_HID_GET_IDLE:
		On_EpReg1_Cls_Hid_GetIdle();
		break;

	case REQTYPE_HID_GET_PROTOCOL:
		On_EpReg1_Cls_Hid_GetProt();
		break;

	case REQTYPE_HID_SET_REPORT:
		On_EpReg1_Cls_Hid_SetReport();
		break;

	case REQTYPE_HID_SET_IDLE:
		On_EpReg1_Cls_Hid_SetIdle();
		break;

	case REQTYPE_HID_SET_PROTOCOL:
		On_EpReg1_Cls_Hid_SetProt();
		break;
