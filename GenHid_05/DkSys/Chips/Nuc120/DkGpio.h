...
#define GPIO_SET_PIN_A0_TO_IO()		CLR_BIT(GPA_MFP, BIT_NO_0)

#define GPIO_SET_PIN_A1_TO_IO()						\
	CLR_BIT(GPA_MFP, BIT_NO_1);						\
	IO_MMAP(ALT_MFP) &= ~(BIT_HEX_11 | BIT_HEX_20)

#define GPIO_SET_PIN_A2_TO_IO()						\
	CLR_BIT(GPA_MFP, BIT_NO_2);						\
	IO_MMAP(ALT_MFP) &= ~(BIT_HEX_11 | BIT_HEX_19)

#define GPIO_SET_PIN_A3_TO_IO()						\
	CLR_BIT(GPA_MFP, BIT_NO_3);						\
	IO_MMAP(ALT_MFP) &= ~(BIT_HEX_11 | BIT_HEX_18)

#define GPIO_SET_PIN_A4_TO_IO()						\
	CLR_BIT(GPA_MFP, BIT_NO_4);						\
	IO_MMAP(ALT_MFP) &= ~(BIT_HEX_11 | BIT_HEX_17)

#define GPIO_SET_PIN_A5_TO_IO()						\
	CLR_BIT(GPA_MFP, BIT_NO_5);						\
	IO_MMAP(ALT_MFP) &= ~(BIT_HEX_11 | BIT_HEX_16)

#define GPIO_SET_PIN_A6_TO_IO()		\
	CLR_BIT(GPA_MFP, BIT_NO_6);		\
	CLR_BIT(ALT_MFP, BIT_NO_11)

#define GPIO_SET_PIN_A7_TO_IO()						\
	CLR_BIT(GPA_MFP, 7);							\
	IO_MMAP(ALT_MFP) &= ~(BIT_HEX_11 | BIT_HEX_2)

#define GPIO_SET_PIN_A8_TO_IO()		CLR_BIT(GPA_MFP, BIT_NO_8)

#define GPIO_SET_PIN_A9_TO_IO()		CLR_BIT(GPA_MFP, BIT_NO_9)

#define GPIO_SET_PIN_A10_TO_IO()	\
	CLR_BIT(GPA_MFP, BIT_NO_10);	\
	CLR_BIT(ALT_MFP, BIT_NO_11)

#define GPIO_SET_PIN_A11_TO_IO()	\
	CLR_BIT(GPA_MFP, BIT_NO_11);	\
	CLR_BIT(ALT_MFP, BIT_NO_11)

#define GPIO_SET_PIN_A12_TO_IO()					\
	CLR_BIT(GPA_MFP, BIT_NO_12);					\
	IO_MMAP(ALT_MFP) &= ~(BIT_HEX_11 | BIT_HEX_21)

#define GPIO_SET_PIN_A13_TO_IO()					\
	CLR_BIT(GPA_MFP, BIT_NO_13);					\
	IO_MMAP(ALT_MFP) &= ~(BIT_HEX_11 | BIT_HEX_22)

#define GPIO_SET_PIN_A14_TO_IO()					\
	CLR_BIT(GPA_MFP, BIT_NO_14);					\
	IO_MMAP(ALT_MFP) &= ~(BIT_HEX_11 | BIT_HEX_23)

#define GPIO_SET_PIN_A15_TO_IO()	\
	CLR_BIT(GPA_MFP, BIT_NO_15);	\
	CLR_BIT(ALT_MFP, BIT_NO_9)

#define GPIO_SET_PIN_B0_TO_IO()		CLR_BIT(GPB_MFP, BIT_NO_0)

#define GPIO_SET_PIN_B1_TO_IO()		CLR_BIT(GPB_MFP, BIT_NO_1)

#define GPIO_SET_PIN_B2_TO_IO()						\
	CLR_BIT(GPB_MFP, BIT_NO_2);						\
	IO_MMAP(ALT_MFP) &= ~(BIT_HEX_11 | BIT_HEX_13)

#define GPIO_SET_PIN_B3_TO_IO()						\
	CLR_BIT(GPB_MFP, BIT_NO_3);						\
	IO_MMAP(ALT_MFP) &= ~(BIT_HEX_11 | BIT_HEX_14)

#define GPIO_SET_PIN_B4_TO_IO()		CLR_BIT(GPB_MFP, BIT_NO_4)

#define GPIO_SET_PIN_B5_TO_IO()		CLR_BIT(GPB_MFP, BIT_NO_5)

#define GPIO_SET_PIN_B6_TO_IO()		\
	CLR_BIT(GPB_MFP, BIT_NO_6);		\
	CLR_BIT(ALT_MFP, BIT_NO_11)

#define GPIO_SET_PIN_B7_TO_IO()		\
	CLR_BIT(GPB_MFP, BIT_NO_7);		\
	CLR_BIT(ALT_MFP, BIT_NO_11)

#define GPIO_SET_PIN_B8_TO_IO()		CLR_BIT(GPB_MFP, BIT_NO_8)

#define GPIO_SET_PIN_B9_TO_IO()		\
	CLR_BIT(GPB_MFP, BIT_NO_9);		\
	CLR_BIT(ALT_MFP, BIT_NO_1)

#define GPIO_SET_PIN_B10_TO_IO()	\
	CLR_BIT(GPB_MFP, BIT_NO_10);	\
	CLR_BIT(ALT_MFP, BIT_NO_0)

#define GPIO_SET_PIN_B11_TO_IO()	\
	CLR_BIT(GPB_MFP, BIT_NO_11);	\
	CLR_BIT(ALT_MFP, BIT_NO_4)

#define GPIO_SET_PIN_B12_TO_IO()					\
	CLR_BIT(GPB_MFP, BIT_NO_12);					\
	IO_MMAP(ALT_MFP) &= ~(BIT_HEX_11 | BIT_HEX_10)

#define GPIO_SET_PIN_B13_TO_IO()	\
	CLR_BIT(GPB_MFP, BIT_NO_13);	\
	CLR_BIT(ALT_MFP, BIT_NO_11)

#define GPIO_SET_PIN_B14_TO_IO()	\
	CLR_BIT(GPB_MFP, BIT_NO_14);	\
	CLR_BIT(ALT_MFP, BIT_NO_3)

#define GPIO_SET_PIN_B15_TO_IO()	CLR_BIT(GPB_MFP, BIT_NO_15)
