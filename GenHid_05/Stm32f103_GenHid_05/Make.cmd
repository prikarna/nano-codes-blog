@rem +---------------------------------------------------------+
@rem   Batch file to build Stm32f103_GenHid_05 project
...
@set PROJ_NAME=Stm32f103_GenHid_05

@echo.
@echo *** Building %PROJ_NAME% project for STM32F103XXXXX microcontroller
@echo.

@set SOLUTION_DIR=D:\Microcontroller\GenHid_05
...
@set SRCS=%SRCS% %SRC_DIR%\UsbDescs.c
